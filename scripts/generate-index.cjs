 ...
 * Called by the GitHub Actions workflow after building.
 *
 * Usage: node scripts/generate-index.js <output-path> [prototype1] [prototype2] ...
 */
...
const prototypeCards = prototypes.length > 0
  ...
  : '<p class="empty">No prototypes deployed yet. Create a branch, push it, and it will appear here automatically.</p>';
